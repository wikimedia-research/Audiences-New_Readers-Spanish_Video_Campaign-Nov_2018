...
save(model_compare, file = "data/eswiki_pv_model_compare.RData")

# Check model compare results
load("data/eswiki_pv_model_compare.RData")
...
# best model is 20 MAPE=0.1056974
...
ggsave("eswiki_pv_impact.png", plot = p, path = 'docs/figures', units = "in", dpi = 300, height = 6, width = 14)
summary(model_impact)
summary(model_impact, "report")
png('docs/figures/eswiki_pv_inclusion_prob.png', units = "in", res = 300, height = 8, width = 10)
